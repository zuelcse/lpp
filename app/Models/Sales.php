...
class Sales extends Model
{
    ...
    public function SalesOrderDetails(): BelongsTo {
        return  $this->belongsTo(SalesOrderDetails::class,'id','sales_id');
    }

    public function SalesDespatchDetails(): BelongsTo {
        return  $this->belongsTo(SalesDespatchDetails::class,'id','sales_id');
    }

    
    public function SalesItemsVariousInformation(): HasMany {
        return  $this->hasMany(SalesItemsVariousInformation::class,'sales_id','id');
    }
