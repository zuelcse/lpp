      ...
      <div class="d-flex align-items-end row">
        <div class="col-sm-7">
          <div class="card-body">
            ...
            <p class="mb-4"><b class="fw-medium">{{ str_replace(array('["','"]'),'',Auth::user()->getRoleNames()) }}</b> </p>
      ...
      <div class="col-lg-6 col-md-12 col-6 mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <h4 title="Sales Quantity/Amount" class="card-title mb-2">{{$sales->sales_qty}}/{{$sales->sales_value==''?0:round($sales->sales_value)}}৳</h4>
      ...
      <div class="col-lg-6 col-md-12 col-6 mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <span class="fw-semibold d-block mb-2">Voucher</span>
            <h4 title="Voucher Quantity/Amount" class="card-title text-nowrap mb-1">{{$receipt->receipt_qty}}/{{$receipt->receipt_value==''?0:round($receipt->receipt_value)}}৳</h4>
