            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="col-xxl">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{url('/ledger/create-action')}}">
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <select type="text" id="main_group_id" class="form-control js-example-basic-single" name="main_group_id" placeholder="Enter Base units" aria-label="Enter Group Name" aria-describedby="main_group_id" onchange="subGroups()" required>
                                                    ...
                                                    <option value="{{$key}}" {{ old('main_group_id') == $key ? 'selected' : '' }}>{{$item}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="name" name="name" placeholder="Enter EN Name" value="{{ old('name') }}"/>
                                                @error('name')
                                    ...
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="name_bn" name="name_bn" placeholder="Enter BN Name" value="{{ old('name_bn') }}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <select type="text" id="region_id" class="form-control js-example-basic-single" name="region_id" placeholder="Enter Region" aria-label="Enter Region" aria-describedby="region_id" onchange="areas()">
                                                    ...
                                                    <option value="{{$key}}" {{ old('region_id') == $key ? 'selected' : '' }}>{{$item}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="address" name="address" placeholder="Enter Address EN" value="{{ old('address') }}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="address_bn" name="address_bn" placeholder="Enter Address BN" value="{{ old('address_bn') }}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="bank_account_holder" name="bank_account_holder" placeholder="Enter EN Name" value="{{ old('bank_account_holder') }}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="bank_account_number" name="bank_account_number" placeholder="Enter EN Name" value="{{ old('bank_account_number') }}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="bank_name" name="bank_name" placeholder="Enter EN Name" value="{{ old('bank_name') }}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="bank_branch" name="bank_branch" placeholder="Enter EN Name" value="{{ old('bank_branch') }}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" id="credit_limit" class="form-control  " name="credit_limit" placeholder="Enter Credit Limit" aria-label="Enter Credit Limit" aria-describedby="credit_limit" value="{{ old('credit_limit') }}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
