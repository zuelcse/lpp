                ...
                <div class="card-body" id="printArea">
                    ...
                    <div class="invoice-box">
                        ...
                        <div class="bottom-section">
                            <?php $currentBalance = $data['gross_amount']-$data['paid_amount']; ?>
                            ...
                            <div class="box summary-box">
                                ...
                                <div><span>Previous Balance:</span><span>...</span></div>
                                <div><span>Payment:</span><span>{{ $data['paid_amount'] }}</span></div>
                                <div><span>Current Balance:</span><span>{{ $currentBalance }}</span></div>
                            </div>
