    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('voucher-adjustment-update', ['id' => $data[0]['id']])}}">
                        @csrf
                        <div class="mb-1 p-2 border border-secondary">
                            <div class="row px-2 pt-2">
                                ...
                                @if(in_array($data[0]['voucher_type'],[11,12]))
                                <div class="col-md-3 col-s-12">
                                    <div class="row">
                                        <label class="col-sm-6 col-form-label" for="cheque_no">Cheque No</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control form-control-sm " id="cheque_no" name="cheque_no" placeholder="Enter Cheque No" required="required" value="{{ $data[0]['cheque_no'] }}"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3 col-s-12">
                                    <div class="row">
                                        <label class="col-sm-6 col-form-label" for="cheque_date">Cheque Date</label>
                                        <div class="col-sm-6">
                                            <input type="date" class="form-control form-control-sm " id="cheque_date" name="cheque_date" value="{{$data[0]['cheque_date']}}" placeholder="Enter Cheque Date" required="required"/>
                                        </div>
                                    </div>
                                </div>
                                @endif                            
                        ...
                        <div class="mb-1">
                            <div class="mt-2 border border-secondary" id="dynamic_field">
                                @foreach ($data[0]['master_voucher'] as $ikey => $ivalue)
                                <div id="key{{$ikey}}" class="row px-4 pt-2">
                                    <div class="col-12 col-sm-3 mb-1">
                                        <div class="row">
                                            <input type="hidden" name="item[{{$ikey}}][id]" value="{{$ivalue['id']}}">
                                            <label class="col-sm-4 col-form-label" for="item{{$ikey}}drname">Debit A/C</label>
                                            <div class="col-sm-8">
                                                <select onchange="fetchItemDetails(0)" class="form-control form-control-sm js-example-basic-single" id="item{{$ikey}}drname"
                                                    name="item[{{$ikey}}][drname]" required="required" >
                                                    <option value="">--Select--</option>
                                                    @foreach ($drLedgers as $key => $item)
                                                    <option value="{{ $key }}" {{ $key==$ivalue['debit_head']?'selected':'' }}>{{ $item }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 col-sm-3 mb-1">
                                        <div class="row">
                                            <label class="col-sm-5 col-form-label" for="item{{$ikey}}crname">Credit A/C</label>
                                            <div class="col-sm-7">
                                                <select class="form-control form-control-sm js-example-basic-single" id="item{{$ikey}}crname" name="item[{{$ikey}}][crname]"
                                                    placeholder="Enter Ledger Type" required="required">
                                                    <option value="">--Select--</option>
                                                    @foreach ($crLedgers as $key => $item)
                                                    <option value="{{ $key }}" {{ $key==$ivalue['credit_head']?'selected':'' }}>{{ $item }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 col-sm-3 mb-1">
                                        <div class="row">
                                            <label class="col-sm-6 col-form-label" for="item{{$ikey}}amount">Amount</label>
                                            <div class="col-sm-6">
                                                <input type="text" onkeyup="getAmount(0)" class="form-control form-control-sm amount" id="item{{$ikey}}amount" name="item[{{$ikey}}][amount]" placeholder="Enter Amount" required="required" value="{{$ivalue['amount']}}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-3 mb-1">
                                        <div class="row">
                                            <label class="col-sm-4 col-form-label" for="dueOn">Note</label>
                                            <div class="col-sm-{{$ikey!=0?6:8}}">
                                                <input type="text" class="form-control form-control-sm " id="item{{$ikey}}note" name="item[{{$ikey}}][note]" placeholder="Enter Note" value="{{$ivalue['note']}}"/>
                                            </div>
                                            @if($ikey!=0)
                                            <div class="col-2">
                                                <span title="Remove the row." onclick="removeItemOnSalesOrder({{$ikey}})" class="text-danger col-form-label cursor-pointer float-end">X</span>
                                            </div>
                                            @endif
                                        </div>
                                    </div>
                        ...
                        <div class="mb-1">
                            <div class="mt-1 mb-1 border border-secondary p-2">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row">
                                            <label class="col-3 col-sm-3 col-form-label" for="basic-default-motor_vehicle_no">Narration/Remarks</label>
                                            <div class="col-12 col-sm-9">
                                                <textarea name="narration_remarks" class="form-control form-control-sm">{{$data[0]['narration_remarks']}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                ...
                `<div id="key${i}" class="row px-4 pt-2">
                    <div class="col-12 col-sm-3 mb-1">
                        <div class="row">
                            ...
                            <label class="col-sm-4 col-form-label" for="item${i}drname">Debit A/C</label>
                            <div class="col-sm-8">
                    ...
                    <div class="col-12 col-sm-3 mb-1">
                        <div class="row">
                            <label class="col-sm-5 col-form-label" for="item${i}crname">Credit A/C</label>
                            <div class="col-sm-7">
                    ...
                    <div class="col-12 col-sm-3 mb-1">
                        <div class="row">
                            <label class="col-6 col-form-label" for="item${i}amount">Amount</label>
                            <div class="col-6">
                    ...
                    <div class="col-12 col-sm-3 mb-1"> 
                        <div class="row">   
                            <label class="col-4 col-form-label" for="item${i}note">Note</label>
                            <div class="col-6">
