    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('voucher-receivecash-create')}}">
                        @csrf
                            ...
                            <div class="mt-2 border border-secondary" id="dynamic_field">
                                <div class="row px-4 pt-2">
                                    ...
                                    <div class="col-12 col-sm-3 mb-1">
                                        <div class="row">
                                            <label class="col-4 col-sm-6 col-form-label" for="item0amount">Amount</label>
                                    ...
                                    <div class="col-12 col-sm-3 mb-1">
                                        <div class="row">
                                            <label class="col-4 col-sm-4 col-form-label" for="dueOn">Note</label>
