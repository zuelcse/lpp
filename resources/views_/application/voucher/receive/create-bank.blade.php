...
@section('title', 'New Bank Receive')
                            ...
                            <div class="row px-2 pt-2">
                                ...
                                <div class="col-md-3 col-s-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control form-control-sm " id="cheque_no" name="cheque_no" placeholder="Enter Cheque No" required="required"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3 col-s-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="date" class="form-control form-control-sm " id="cheque_date" name="cheque_date" value="{{date('Y-m-d')}}" placeholder="Enter Cheque Date" required="required"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-2 border border-secondary" id="dynamic_field">
                                <div class="row px-4 pt-2">
                                    <div class="col-12 col-sm-3 mb-1">
                                        <div class="row">
                                            <label class="col-sm-4 col-form-label" for="item0drname">Debit A/C</label>
                                    ...
                                    <div class="col-12 col-sm-3 mb-1">
                                        <div class="row">
                                            <label class="col-sm-5 col-form-label" for="item0crname">Credit A/C</label>
                                    ...
                                    <div class="col-12 col-sm-3 mb-1">
                                        <div class="row">
                                            <label class="col-sm-6 col-form-label" for="item0amount">Amount</label>
                                    ...
                                    <div class="col-12 col-sm-3 mb-1">
                                        <div class="row">
                                            <label class="col-sm-4" for="dueOn">Note</label>
                                            <div class="col-sm-8">
