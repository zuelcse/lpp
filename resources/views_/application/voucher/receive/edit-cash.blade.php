    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('voucher-receivecash-update', ['id' => $data[0]['id']])}}">
                        @csrf
                        <div class="mb-1 p-2 border border-secondary">
                            <div class="row px-2 pt-2">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="row">
                                        <label class="col-4 col-sm-3 col-form-label" for="drname">Debit A/C</label>
                                        <div class="col-12 col-sm-9">
                                            <select class="form-control form-control-sm" id="drname"
                                                name="drname" required="required" >
                            ...
                            <div class="mt-2 border border-secondary" id="dynamic_field">
                                ...
                                <div id="key{{$ikey}}" class="row px-4 pt-2">
                                    <div class="col-12 col-sm-6 mb-1">
                                        <div class="row">
                                            <label class="col-4 col-sm-3 col-form-label" for="item0crname">Credit A/C</label>
                                            <div class="col-12 col-sm-9">
                                    ...
                                    <div class="col-12 col-sm-3 mb-1">
                                        <div class="row">
                                            <label class="col-4 col-sm-6 col-form-label" for="item{{$ikey}}amount">Amount</label>
                                            <div class="col-12 col-sm-6">
                                                <input type="text" onkeyup="getAmount({{$ikey}})" class="form-control form-control-sm amount" id="item{{$ikey}}amount" name="item[{{$ikey}}][amount]" placeholder="Enter Amount" required="required" value="{{$ivalue['amount']}}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-3 mb-1">
                                        <div class="row">
                                            <label class="col-4 col-sm-4 col-form-label" for="item{{$ikey}}note">Note</label>
                                            <div class="col-8 col-sm-{{$ikey!=0?6:8}}">
                        ...
                        <div class="mb-1">
                            <div class="mt-1 mb-1 border border-secondary p-2">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row">
                                            <label class="col-12 col-sm-3 col-form-label" for="basic-default-motor_vehicle_no">Narration/Remarks</label>
                                            <div class="col-12 col-sm-9">
        ...
        function newItemOnSalesOrder() {
            let salesNewItemForm =
                `<div id="key${i}" class="row px-4 pt-2">
                    <div class="col-12 col-sm-6 mb-1">
                        <div class="row">
                            <label class="col-4 col-sm-3 col-form-label" for="item${i}crname">Credit A/C</label>
                            <div class="col-12 col-sm-9">
