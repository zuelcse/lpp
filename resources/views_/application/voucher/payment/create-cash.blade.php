...
@section('title', 'New Cash Payment')
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('voucher-paymentcash-create')}}">
                        @csrf
                        ...
                        <div class="mb-1 p-2 border border-secondary">
                            <div class="row px-2 pt-2">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="row">
                                        <label class="col-sm-3 col-form-label" for="crname">Credit A/C</label>
                                        <div class="col-12 col-sm-9">
                                            <select class="form-control form-control-sm"
                                                id="crname" name="crname"
                            ...
                            <div class="mt-2 border border-secondary" id="dynamic_field">
                                <div class="row px-4 pt-2">
                                    <div class="col-12 col-sm-6 mb-1">
                                        <div class="row">
                                            <label class="col-sm-3 col-form-label" for="item0drname">Debit A/C</label>
                                            <div class="col-sm-9">
                                    ...
                                    <div class="col-12 col-sm-3 mb-1">
                                        <div class="row">
                                            <label class="col-12 col-sm-6 col-form-label" for="item0amount">Amount</label>
                                            <div class="col-12 col-sm-6">
        ...
        function newItemOnSalesOrder() {
            let salesNewItemForm =
                `<div id="key${i}" class="row px-4 pt-2">
                    <div class="col-12 col-sm-6 mb-1">
                        <div class="row">
                            <label class="col-sm-3 col-form-label" for="item${i}drname">Debit A/C</label>
                            <div class="col-sm-9">
