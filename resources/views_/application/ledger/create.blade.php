                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <select type="text" id="sub_group_id" class="form-control js-example-basic-single" name="sub_group_id" placeholder="Enter Base units" aria-label="Enter Group Name" aria-describedby="sub_group_id">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="name_bn" name="name_bn" placeholder="Enter BN Name" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="address" name="address" placeholder="Enter Address EN" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="address_bn" name="address_bn" placeholder="Enter Address BN" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="bank_account_holder" name="bank_account_holder" placeholder="Enter EN Name" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="bank_account_number" name="bank_account_number" placeholder="Enter EN Name" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="bank_name" name="bank_name" placeholder="Enter EN Name" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="bank_branch" name="bank_branch" placeholder="Enter EN Name" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" id="credit_limit" class="form-control  " name="credit_limit" placeholder="Enter Credit Limit" aria-label="Enter Credit Limit" aria-describedby="credit_limit" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
