                                    ...
                                    @forelse($data as $key => $item)
                                        <tr>
                                            ...
                                            <td class="flex items-center justify-content-between">
                                                <a class="btn btn-success" href="{{url('setting/subgroup/update/'.$item->id)}}" onclick="return confirm('Are you sure you want to update this Size?')">Edit</a>
                                            </td>
                                        </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('setting-master-size-create') }}">
            @csrf
