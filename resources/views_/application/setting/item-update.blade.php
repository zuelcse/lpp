            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="col-xxl">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{url('/setting/item-update/'.$item->id)}}">
                                @csrf
                                <div class="row">
                                    <div class="col-12 col-sm-6 mb-1">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-8">
                                                <input type="text" class="form-control" id="basic-default-name" name="name" placeholder="Enter EN Name" value="{{$item->name}}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 mb-1">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-8">
                                                <input type="text" class="form-control" id="basic-default-name_bn" name="name_bn" placeholder="Enter BN Name" value="{{$item->name_bn}}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 mb-1">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <select type="text" id="manufacturer" class="form-control  " name="manufacturer" placeholder="Enter Base units" aria-label="Enter Group Name" aria-describedby="manufacturer">
                                                    ...
                                                    @foreach($allManufacturer as $key => $itm)
                                                    <option value="{{$key}}" {{$key == $item->manufacturer?'selected':''}}>{{$itm}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <select type="text" id="category" class="form-control  " name="category" placeholder="Enter Group Name" aria-label="Enter Group Name" aria-describedby="category">
                                                    ...
                                                    @foreach($allGroup as $key => $itm)
                                                    <option value="{{$key}}" {{$key == $item->category?'selected':''}}>{{$itm}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 col-sm-6 mb-1">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" id="barcode" class="form-control  " name="barcode" placeholder="Enter Barcode No" aria-label="Enter Barcode No" aria-describedby="taxClassificationName" value="{{$item->barcode}}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 mb-1">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" id="part_no" class="form-control  " name="part_no" placeholder="Enter Part No" aria-label="Enter Tax Part No" aria-describedby="part_no" value="{{$item->part_no}}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 mb-1">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <select type="text" id="unit" class="form-control  " name="unit" placeholder="Enter unit" aria-label="Enter unit" aria-describedby="unit">
                                                    ...
                                                    @foreach($allUnits as $key => $itm)
                                                    <option value="{{$key}}" {{$key == $item->unit?'selected':''}}>{{$itm}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 col-sm-6 mb-1">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" id="salesRate" class="form-control  " name="salesRate" placeholder="Enter Sales Rate" aria-label="Enter Sales Rate" aria-describedby="salesRate" value="{{$item->salesRate}}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
